import PresentationKit from '@/components/vault/PresentationKit';
  ...
  return (
    <div className="relative max-w-2xl mx-auto">
      ...
      <div className="relative">
        ...
        <h1 className="font-display font-bold text-2xl text-white mb-1">Presentation Kit</h1>
        <p className="font-body text-sm text-white/60 mb-6">
          Turn a topic, a Vault item, or a document into a PowerPoint (PPTX) ready to present.
        </p>
        <PresentationKit />
      </div>
    </div>
