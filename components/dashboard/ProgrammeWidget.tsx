  ...
  return (
    <div className="bg-navy rounded-none p-5">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-gold text-navy font-condensed font-bold text-xs uppercase px-4 py-2.5 rounded-none hover:bg-gold-light transition-colors"
      >
